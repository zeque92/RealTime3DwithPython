...
class Landscape:
    ...
    def __init__(self, width, height, music_file):
        self.width = width
        self.height = height
    ...
    def plotInstructions(self):
        ...
        self.plotInfoBlit(400,  70, "f key:              toggle full screen mode on/off")
        self.plotInfoBlit(400,  85, "ESC key:            exit")
...
if __name__ == '__main__':
    ...
    ls = Landscape(disp_size[0], disp_size[1], music_file)
